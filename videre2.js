	...
	var Video = {
		...
		wrapPlayer : function (el) {
			var base = this;
				...
				template = $(
								'<div class="vid-html5">'+
									'<iframe allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" src="'+base.options.video.quality[0].src+'" id="html-player" style="width: '+dimensions[base.options.dimensions][0]+'px; height: '+dimensions[base.options.dimensions][1]+'px;"></iframe>'+
								'</div>'+
